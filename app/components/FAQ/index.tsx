                    ...
                    <Disclosure as="div" className="mt-2">
                        {({ open }) => (
                            <>
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                                    Not at all. I work with clients from a wide range of industries – from small businesses and start-ups to larger organisations. Whether you're a local shop, a tradesperson, or a creative agency, I can help bring your online presence to life. 
                    ...
                    <Disclosure as="div" className="mt-2">
                        {({ open }) => (
                            <>
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                                    Every project is different, so costs can vary depending on your requirements. After an initial consultation, I’ll provide a personalised quote based on your needs, goals, and budget. I offer transparent pricing with no hidden fees.                                </Disclosure.Panel>
                            </>
                        )}
                    </Disclosure>
                </div>
                    ...
                    <Disclosure as="div" className="mt-2">
                        {({ open }) => (
                            <>
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                                   Yes. I can build your site using a content management system (CMS) like WordPress, making it easy for you to update text, images, and more. I also provide training and support if needed.<br /> <br /> I offer maintenance packages to keep your site secure, up to date, and running smoothly. You can choose a one-off update or a monthly plan, depending on your needs. 
                                </Disclosure.Panel>
                            </>
                        )}
                    </Disclosure>
